...
const f1Data = [
  ...
  { id: 3, name: 'Antonelli', color: '#00D2BE', img: '/drivers/antonelli.webp', podiums: 3 },
  ...
  { id: 8, name: 'Gasly', color: '#FF87BC', img: '/drivers/gasly.webp', podiums: 5 },
  { id: 9, name: 'Hadjar', color: '#6692FF', img: '/drivers/hadjar.webp', podiums: 1 },
  { id: 10, name: 'Hamilton', color: '#EF1A2D', img: '/drivers/hamilton.webp', podiums: 202 },
  { id: 11, name: 'Hulkenberg', color: '#00e701', img: '/drivers/hulkenberg.webp', podiums: 1 },
  { id: 12, name: 'Lawson', color: '#6692FF', img: '/drivers/lawson.webp', podiums: 0 },
  { id: 13, name: 'Leclerc', color: '#EF1A2D', img: '/drivers/leclerc.webp', podiums: 50 },
  { id: 14, name: 'Lindblad', color: '#101C50', img: '/drivers/lindblad.webp', podiums: 0 },
  { id: 15, name: 'Norris', color: '#FF8000', img: '/drivers/norris.webp', podiums: 44 },
  { id: 16, name: 'Ocon', color: '#B6BABD', img: '/drivers/ocon.webp', podiums: 4 },
  { id: 17, name: 'Perez', color: '#101C50', img: '/drivers/perez.webp', podiums: 39 },
  { id: 18, name: 'Piastri', color: '#FF8000', img: '/drivers/piastri.webp', podiums: 26 },
  { id: 19, name: 'Russell', color: '#00D2BE', img: '/drivers/russell.webp', podiums: 24 },
  { id: 20, name: 'Sainz', color: '#005AFF', img: '/drivers/sainz.webp', podiums: 29 },
  { id: 21, name: 'Stroll', color: '#006F62', img: '/drivers/stroll.webp', podiums: 3 },
  { id: 22, name: 'Verstappen', color: '#101C50', img: '/drivers/verstappen.webp', podiums: 127 }
];
